package org.centric.generator.provider.java.model;
...
import org.centric.generator.util.IOHelper;
import org.centric.generator.util.StringHelper;
import org.centric.generator.util.paranamer.AdaptiveParanamer;
import org.centric.generator.util.paranamer.BytecodeReadingParanamer;
import org.centric.generator.util.paranamer.CachingParanamer;
import org.centric.generator.util.paranamer.DefaultParanamer;
import org.centric.generator.util.paranamer.JavaSourceParanamer;
import org.centric.generator.util.paranamer.Paranamer;
...
public class MethodParameter {
	...
	public static class JavaSourceFileMethodParametersParser {
		...
		public String[] parseJavaFileForParamNames(Method method, String content) {
			Pattern methodPattern = Pattern.compile("(?s)" + method.getName() + "\\s*\\(" + getParamsPattern(method)
					+ "\\)\\s*\\{");
