package org.centric.generator.provider.db.table.model;
...
import org.centric.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import org.centric.generator.provider.db.table.model.util.ColumnHelper;
import org.centric.generator.util.GLogger;
import org.centric.generator.util.StringHelper;
import org.centric.generator.util.TestDataGenerator;
import org.centric.generator.util.typemapping.ActionScriptDataTypesUtils;
import org.centric.generator.util.typemapping.DatabaseDataTypesUtils;
import org.centric.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column implements java.io.Serializable,Cloneable{
	 ...
	 * 判断是否是需要排除的通用字段
	 */
	public boolean isRemoveField(String fieldName){
		String fieldRemoves = GeneratorProperties.getProperty("fieldRemove", "");
		for(String fieldRemove : fieldRemoves.split(",")) {
			if(fieldRemove!=null&&fieldRemove.equals(fieldName)) {
				return true;
			}
		}
		return false;
