...
public class JedisUtils {
	...
	private static JedisPool jedisPool = JedisPoolFactory.pool;
...
//				logger.debug("get {} = {}", key, value);
	 ...
	 * @return
	 */
	public static String setexNew(String key, int seconds, String value){
		key = KEY_PREFIX + key;
		String result = null;
		Jedis jedis = null;
		try {
...
//			}
	 ...
	 * @return
	 */
	public static long setString(String key, String value, int cacheSeconds) {
		key = KEY_PREFIX + key;
		long result = 0;
		Jedis jedis = null;
		try {
